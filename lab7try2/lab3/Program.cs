...
public class Program
{
    public static void Main()
    {
        ...
        var deviceCollection = new CollectionType<Device>();
        deviceCollection.Add(new Device { Name = "Printer", Type = "Peripheral" });
        deviceCollection.DisplayItems();



        deviceCollection.SaveToFile("dilane");


        var NdeviceCollection = new CollectionType<Device>();
        NdeviceCollection.LoadFromFile("dilane");
        NdeviceCollection.DisplayItems();
