...
namespace lab10
{
    public class Abiturient
    {
        ...
        public double CalculateSumGrades() => Grades.Sum(); // Метод для вычисления суммы оценок
        public bool HasUnsatisfactoryGrades() => Grades.Any(g => g < PassingGrade); // Метод для проверки неудовлетворительных оценок
